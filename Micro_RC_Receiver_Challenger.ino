...
// Used in:
// - Maisto Dodge Challenger (vehicle number 4, with taillights and brakelights)
...
Servo servo1;
//Servo servo2; // used for taillight
Servo servo3;
Servo servo4;
...
void setup() {
  ...
  // LED setup
  tailLight.begin(A1); // A1 = Servo 2 Pin
  ...
  // Servo pins
  servo1.attach(A0);
  //servo2.attach(A1); // used for taillight
  servo3.attach(A2);
  servo4.attach(A3);
...
void led() {
  ...
  // Lights switching off 10s after the vehicle did stop
...
void writeServos() {
  servo1.write(map(data.axis1, 100, 0, 120, 55) ); // 45 - 135° in theory (for Dodge Challenger R 120 - L 55)
  //servo2.write(map(data.axis2, 100, 0, 45, 135) ); // 45 - 135° // used for taillight
